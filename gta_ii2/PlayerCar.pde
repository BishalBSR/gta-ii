class PlayerCar {
  ...
  PImage playerCar;
  int carSize;
  float carRight, carLeft, carTop, carBottom;
  ...
  PlayerCar() {
    ...
    carRight = location.x+carSize/2;
    carLeft = location.x-carSize/2;
    carTop = location.y-carSize/4;
    carBottom = location.y+carSize/4;
  }
  ...
  void speedUp() {
    PVector amount = new PVector(0.25, 0);
